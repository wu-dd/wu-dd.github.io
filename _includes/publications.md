...
<div class="pub-row">
  ...
  {%- endif -%}
    ...
    <div class="links">
      ...
      {% endif %}
      {% if link.research %}
      <span class="research-badge" style="display:inline-block; font-size:12px; color:#828282; border:1px solid #000000; background:#ffffff; padding:0.1rem 0.5rem; cursor:default; text-decoration:none;">{{ link.research }}</span>
      {% endif %}
      {% if link.page %} 
